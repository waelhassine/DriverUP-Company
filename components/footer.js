...
const Footer = (props) => {
            ...
            <div className="grid lg:grid-cols-3 gap-20 ">
              ...
              <div className="col-span-1 flex flex-row space-x-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-main-3 font-medium">(995) 551 009 054</p>
                </div>
              </div>
              <div className="col-span-1 flex flex-row space-x-3">
            ...
            <div className="grid lg:grid-cols-4 gap-8">
              <div className="col-span-1 space-y-8">
                ...
                <p className="text-main-3">
                  Videbook is helping people bring to life their digital
                  memories and to create unforgattable gifts.
                </p>
              </div>
              <div className="col-span-1 space-y-8">
          ...
          <div className="container mx-auto flex place-items-center flex-col space-y-24 ">
            ...
            <div className="grid lg:grid-cols-4 gap-8">
              <div className="col-span-1 space-y-8">
                ...
                <p className="text-main-3">
                  ვიდეობუქი უკვე რამდენიმე წელია ეხმარება ადამიანებს თავიანთი
                  ციფრული მოგონებების გაცოცხლებაში და ულამაზესი საჩუქრის
                  დამზადებაში.
                </p>
              </div>
              <div className="col-span-1 space-y-8">
  ...
  return <div>{lang ? <FooterGe /> : <FooterEn />}</div>;
};
